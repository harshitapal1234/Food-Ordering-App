        ...
        holder.txtFavorite.setOnClickListener {
            if (!DBAsyncTask(context, restaurantEntity, 1).execute().get()) {
                ...
                if (result) {
                    ...
                    holder.txtFavorite.background = context.resources.getDrawable(R.drawable.ic_filled)
                ...
                if (result) {
                    ...
                    holder.txtFavorite.background = context.resources.getDrawable(R.drawable.ic_notfill)
