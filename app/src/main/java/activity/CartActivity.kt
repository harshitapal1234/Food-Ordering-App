...
class CartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        restaurantId = getIntent().getStringExtra("restaurantId").toString()
        restaurantName = getIntent().getStringExtra("restaurantName").toString()
        selectedItemsId = getIntent().getStringArrayListExtra("selectedItemsId") as ArrayList<String>
    ...
    fun createNotification() {
        ...
        notificationBuilder.setSmallIcon(R.drawable.resimg)
